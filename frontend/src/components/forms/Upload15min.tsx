...
export default function Upload15min() {
  ...
  return (
    <div className="bg-white dark:bg-darkgray p-6 relative w-full break-words">
      <h5 className="text-xl font-semibold mb-4 text-center">Nalaganje izpiska iz MojElektro.si za 15-minutno porabo</h5>
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
            <div className="w-full flex flex-col gap-4 items-center">
              ...
              {file ? (
                ...
                error === 'Naloži datoteko.' && <p className="text-sm text-red-600 mt-1 text-center">Naložite datoteko.</p>
              )}
            </div>
            ...
            {error && error !== 'Naloži datoteko.' && (
              <div className="mt-3 text-red-600 text-sm font-medium text-center w-full">{error}</div>
            )}
            {resultMsg && <div className="mt-3 text-green-600 text-sm font-medium text-center w-full">{resultMsg}</div>}
          </form>
        )}
