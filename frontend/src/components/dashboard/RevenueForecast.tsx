    ...
    <div className="rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 relative w-full break-words">
      <div className="flex justify-between items-center">
        ...
        <Select
          ...
          required
        >
          <option value="This Week">Ta mesec</option>
          <option value="April 2024">April 2025</option>
          <option value="May 2024">May 2025</option>
          <option value="June 2024">June 2025</option>
        </Select>
      </div>
